...
- Clickable statusbar with my build of [dwmblocks](https://github.com/ayham291/dwmblocks).
...
```
git clone https://github.com/ayham291/dwm
cd dwm
sudo make install
```
...
This is a fork of Luke's build of dwm.
